    ...
    <section ref={ref} className="py-24 px-6 bg-white border-y border-stone-200 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
        <div className="pr-0 md:pr-12">
          ...
          <div className="h-1 w-20 bg-[#BF5738] rounded-full mb-8"></div>
          ...
          <p className="text-lg text-slate-600 leading-relaxed font-light mb-8">
            ...
            We build <span 
                ...
                className="font-semibold text-[#BF5738] border-b border-[#BF5738]/30 hover:border-[#BF5738] cursor-pointer hover:bg-[#BF5738]/5 transition-all"
            >
          ...
          <div className="flex flex-col gap-4">
             <div className="flex gap-6 mb-4">
                <div className="flex items-center gap-2 text-sm font-medium text-slate-500">
                   <Brain className="w-4 h-4 text-[#BF5738]" /> Encoded Knowledge
                </div>
                 <div className="flex items-center gap-2 text-sm font-medium text-slate-500">
                   <Sparkles className="w-4 h-4 text-[#BF5738]" /> Taste Logic
                </div>
             </div>
          </div>
        </div>
        ...
        >
           ...
           <div className="absolute bottom-4 right-6 z-10">
              <div className="flex items-center gap-2 bg-white/80 backdrop-blur px-3 py-1.5 rounded-full border border-slate-100 shadow-sm">
                 <div className="w-1.5 h-1.5 bg-[#BF5738] rounded-full animate-pulse"></div>
